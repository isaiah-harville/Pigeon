...
//  Pigeon
//
//  Camera-based QR scanning for in-person contact exchange (iOS). On macOS,
//  where this dev build also runs, scanning is unavailable and callers fall
//  back to pasting the contact code.
//
